...
# meta version: 2.4.18 # Версия обновлена, подтверждая реализацию всех требований по отслеживанию ролей.
