        ...
        if stop_words_list:
            ...
            for sw_entry in stop_words_list:
                ...
                if sw_target_uids:
                    ...
                    stop_word_entries.append(self.strings["stop_word_entry_with_users"].format(word, ", ".join(sw_user_names)))
                else:
